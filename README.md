...
The interactive dashboard has been deployed on **Streamlit Community Cloud** and is available online:

🔗 https://jet-engine-hospital-hope.streamlit.app/

The deployed application performs inference using the exported artifacts generated by the notebook, ensuring consistency between the notebook and the web interface.
